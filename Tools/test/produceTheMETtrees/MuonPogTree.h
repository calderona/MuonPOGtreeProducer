...
namespace muon_pog {
  ...
  public:
    ...
    Float_t pfMetPx;   // raw PF MET [GeV]
    Float_t pfMetPy;   // raw PF MET [GeV]
  ...
  public:
    ...
    ///aditional variables needed:
    Float_t invMassWithTag;
    Float_t dRclosest;
    ...
    // PF info
    Int_t isIsolatedMuon;
    Int_t isGlobalTightMuon;
    Int_t isTrackerTightMuon;
